#R Code for generating the data of the Figures 8 - 14 in the paper "Sequential Monte-Carlo testing by betting"
...
results_arr=array(NA, c(length(mus), length(alphas), length(ns), length(labs), length(types), length(c_factors), length(dists)), 
